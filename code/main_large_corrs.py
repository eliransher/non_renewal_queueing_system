...
for sample in range(5000):
    try:
        ...
        for mom in range(1, 11):
            moms_arrive.append((arrivals_norm ** mom).mean())
        ...
        moms_ser1 = []
        for mom in range(1, 11):
            moms_ser1.append((services_times[station] ** mom).mean())
        ...
        moms_ser0 = []
        for mom in range(1, 11):
            moms_ser0.append((services_times[station] ** mom).mean())

        moms_ser0 = np.array(moms_ser0)



        input_ = np.concatenate((moms_arrive, moms_ser0), axis=0)
        ...
        inp_depart_0 = np.concatenate((moms_arrive, moms_ser0))
        ...
        rate = services_times[0].mean()
        path_depart_0 = '/scratch/eliransc/non_renewal/depart_0_large_corrs'
        ...
        inp_depart_1 = np.concatenate((np.log(np.array(depart_0_moms)), np.array(corrs_0), np.log(np.array(moms_ser1))))
        ...
        path_depart_1 = '/scratch/eliransc/non_renewal/depart_1_large_corrs'
        ...
        inp_steady_0 = np.concatenate((moms_arrive, moms_ser0))
        ...
        input_ = np.concatenate((moms_arrive, moms_ser1), axis=0)
        output = n_Queue_single_station.get_steady_single_station()
        ...
        path_steady_0 = '/scratch/eliransc/non_renewal/steady_0_large_corrs'
        ...
        inp_steady_1 = np.concatenate((np.log(np.array(depart_0_moms)), np.array(corrs_0), np.log(np.array(moms_ser1))))
        ...
        path_steady_1 = '/scratch/eliransc/non_renewal/steady_1_large_corrs'
        rate = services_times[1].mean()
