...
path = '/scratch/eliransc/non_renewal/steady_1_train_long2'
...
for batch_num in tqdm(range( num_batches)):
    ...
    batch_name = 'train_long2_steady_1_from_'+cluster_name+'_batch_num_' + str(batch_num+len(os.listdir(path_dump_data_depart_0)))+'.pkl'
