...
for sample in range(5000):
    if True:
        ...
        arrivals = get_ph_by_scv_val(0, 4)
        ...
        services_times = {}
        moms_ser = {}
        rates_ser = [np.random.uniform(0.5,0.75), np.random.uniform(0.0,0.95)]
        for station in range( num_stations):
        ...
        path_depart_0 = '/scratch/eliransc/non_renewal/new_depart_0_mid'
        ...
        path_depart_1 = '/scratch/eliransc/non_renewal/new_depart_1_mid'
        ...
        path_steady_1 = '/scratch/eliransc/non_renewal/new_steady_1_mid'
