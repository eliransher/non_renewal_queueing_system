...
for sample in range(5000):
    if True:
        ...
        arrivals = get_ph_by_scv_val(0, 6)
        ...
        services_times = {}
        moms_ser = {}
        rates_ser = [np.random.uniform(0.0,0.5), np.random.uniform(0.0,0.5)]
        for station in range( num_stations):
            services = get_ph_by_scv_val(0, 10) ## should be returned to get_ph()
        ...
        path_depart_0 = '/scratch/eliransc/non_renewal/new_depart_0_low_a'
        ...
        path_depart_1 = '/scratch/eliransc/non_renewal/new_depart_1_low_a'
        ...
        path_steady_1 = '/scratch/eliransc/non_renewal/new_steady_1_low_a'
