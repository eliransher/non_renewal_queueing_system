...
if __name__ == '__main__':
    ...
    for ind in range(20):
        if True:
            ...
            choen_inds = []
            for ind in range(2):
                ind_c = np.random.choice(list(map_trace.keys()))
            ...
            if SAE < 0.03:
                ...
                pkl.dump((choen_inds, label, L_dist, rho,a, error_nn, errorwhitt), open(os.path.join(dump_path, 'result_{}.pkl'.format(np.random.randint(1,1000))), 'wb'))
