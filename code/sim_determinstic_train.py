...
for sample in range(5000):
    try:
        ...
        for station in range( num_stations):
            ...
            rate = np.random.uniform(0.15, 0.95)
        ...
        path_depart_0 = '/scratch/eliransc/non_renewal/depart_0_train_deter'
        file_name = 'deter_correlation_'+str(correlation0)+ '_' +  str(rate)[:5] + 'sim_time_' + str(sim_time) + 'depart_0_multi_corrs1_' + str(model_num)+ '.pkl'
        ...
        path_depart_1 = '/scratch/eliransc/non_renewal/depart_1_train_deter'

        file_name = 'deter_correlation_'+str(correlation1)+ '_' + str(rate)[:5] + 'sim_time_' + str(sim_time) + 'depart_1_multi_corrs1_' + str(model_num)+ '.pkl'
        ...
        path_steady_0 = '/scratch/eliransc/non_renewal/steady_0_train_deter'

        file_name = 'deter_'+str(rate)[:5] + 'sim_time_' + str(sim_time) + 'steady_0_multi_corrs1_' + str(model_num)+ '.pkl'
        ...
        path_steady_1 = '/scratch/eliransc/non_renewal/steady_1_train_deter'

        file_name = 'deter_correlation_' + str(correlation0)+ '_' + str(rate)[:5] + 'sim_time_' + str(sim_time) + 'steady_1_multi_corrs1_' + str(model_num)+ '.pkl'
